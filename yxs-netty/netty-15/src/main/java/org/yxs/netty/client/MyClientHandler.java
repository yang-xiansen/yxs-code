...
public class MyClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext context) throws Exception {
        ...
        //通知服务器端链接成功  ｛不需要通过ByteBuf，可以直接发送字符串｝
        String str = "来自client通知 --> 建立连接成功 " + " IP:" + socketChannel.localAddress().getHostString();
        context.writeAndFlush(MsgUtil.buildMsg(socketChannel.id().toString(), str));
    }
