...
public class MyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext context) throws Exception {
        //当有客户端链接时，添加到channelGroup通信组中
        ChannelHandler.channels.add(context.channel());
        ...
        String str = "建立连接成功 " + new Date() + " " + socketChannel.localAddress().getHostString() + "\r\n";
