/*
 ...
 Source Host           : yxs.yang-xiansen.top:3306
...
INSERT INTO `book` VALUES (102, 'http://localhost:9090/api/file/0wme80.jpg', 'sfd', 'safd', 'sdf', 'asfd', 'asfdas', 2);
...
CREATE TABLE `jotter_article`  (
  ...
  `article_content_html` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'html格式内容',
  `article_content_md` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'md格式内容',
  `article_abstract` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件摘要',
  `article_cover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, '/admin', 'AdminIndex', '首页', 'el-icon-s-home', 'AdminIndex', 0);
INSERT INTO `menu` VALUES (2, '/admin/dashboard', 'DashboardAdmin', '运行情况', NULL, 'dashboard/admin/index', 1);
INSERT INTO `menu` VALUES (3, '/admin', 'User', '用户管理', 'el-icon-user', 'AdminIndex', 0);
INSERT INTO `menu` VALUES (4, '/admin', 'Content', '内容管理', 'el-icon-tickets', 'AdminIndex', 0);
INSERT INTO `menu` VALUES (5, '/admin', 'System', '系统配置', 'el-icon-s-tools', 'AdminIndex', 0);
INSERT INTO `menu` VALUES (6, '/admin/user/profile', 'Profile', '用户信息', NULL, 'user/UserProfile', 3);
INSERT INTO `menu` VALUES (7, '/admin/user/role', 'Role', '角色配置', NULL, 'user/Role', 3);
INSERT INTO `menu` VALUES (8, '/admin/content/book', 'BookManagement', '图书管理', NULL, 'content/BookManagement', 4);
INSERT INTO `menu` VALUES (9, '/admin/content/banner', 'BannerManagement', '广告管理', NULL, 'content/BannerManagement', 4);
INSERT INTO `menu` VALUES (10, '/admin/content/article', 'ArticleManagement', '文章管理', NULL, 'content/ArticleManagement', 4);
...
-- ----------------------------
INSERT INTO `permission` VALUES (1, 'users_management', '用户管理', '/api/admin/user');
INSERT INTO `permission` VALUES (2, 'roles_management', '角色管理', '/api/admin/role');
INSERT INTO `permission` VALUES (3, 'content_management', '内容管理', '/api/admin/content');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'sysAdmin', '系统管理员', 1);
INSERT INTO `role` VALUES (2, 'contentManager', '内容管理员', 1);
INSERT INTO `role` VALUES (3, 'visitor', '访客', 1);
INSERT INTO `role` VALUES (9, 'test', '测试角色', 1);
...
-- ----------------------------
INSERT INTO `role_menu` VALUES (19, 4, 1);
INSERT INTO `role_menu` VALUES (20, 4, 2);
INSERT INTO `role_menu` VALUES (21, 3, 1);
INSERT INTO `role_menu` VALUES (22, 3, 2);
INSERT INTO `role_menu` VALUES (23, 9, 1);
INSERT INTO `role_menu` VALUES (24, 9, 2);
INSERT INTO `role_menu` VALUES (121, 1, 1);
INSERT INTO `role_menu` VALUES (122, 1, 2);
INSERT INTO `role_menu` VALUES (123, 1, 3);
INSERT INTO `role_menu` VALUES (124, 1, 6);
INSERT INTO `role_menu` VALUES (125, 1, 7);
INSERT INTO `role_menu` VALUES (126, 1, 4);
INSERT INTO `role_menu` VALUES (127, 1, 8);
INSERT INTO `role_menu` VALUES (128, 1, 9);
INSERT INTO `role_menu` VALUES (129, 1, 10);
INSERT INTO `role_menu` VALUES (130, 1, 5);
INSERT INTO `role_menu` VALUES (188, 2, 1);
INSERT INTO `role_menu` VALUES (189, 2, 2);
INSERT INTO `role_menu` VALUES (190, 2, 4);
INSERT INTO `role_menu` VALUES (191, 2, 8);
INSERT INTO `role_menu` VALUES (192, 2, 9);
INSERT INTO `role_menu` VALUES (193, 2, 10);
...
-- ----------------------------
INSERT INTO `role_permission` VALUES (83, 5, 3);
INSERT INTO `role_permission` VALUES (108, 1, 1);
INSERT INTO `role_permission` VALUES (109, 1, 2);
INSERT INTO `role_permission` VALUES (110, 1, 3);
INSERT INTO `role_permission` VALUES (139, 2, 3);
...
CREATE TABLE `user`  (
  ...
  `enabled` int(2) NULL DEFAULT NULL COMMENT '账户是否可用 1可用 2不可用',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (4, 'ceshi', '494a859089a39eac94b6ff0f6252f3c9', '6q6C9bkDGOz6QNXqTMpiAw==', 'ceshi', '123456789', '1234567@qq.com', NULL);
INSERT INTO `user` VALUES (5, 'ceshi1', '494a859089a39eac94b6ff0f6252f3c9', '6q6C9bkDGOz6QNXqTMpiAw==', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (6, 'ceshi2', '494a859089a39eac94b6ff0f6252f3c9', '6q6C9bkDGOz6QNXqTMpiAw==', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (7, 'ceshi3', '494a859089a39eac94b6ff0f6252f3c9', '6q6C9bkDGOz6QNXqTMpiAw==', NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `user_role` VALUES (40, 7, 2);
INSERT INTO `user_role` VALUES (63, 6, 2);
INSERT INTO `user_role` VALUES (64, 4, 1);
INSERT INTO `user_role` VALUES (67, 5, 3);
